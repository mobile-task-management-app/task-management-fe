...
const LAYOUT_RATIOS = {
  ...
  TASK_CARD_WIDTH: 0.72,
  TASK_CARD_HEIGHT: 0.8,
  TASK_CARD_RIGHT: -0.16,
} as const;

interface WelcomeOnboardingScreen {
  onNext?: () => void;
  onSkip?: () => void;
}

export const WelcomeOnboardingScreen: React.FC<WelcomeOnboardingScreen> = ({
  onNext,
  onSkip,
}) => {
...
const createStyles = (layout: ReturnType<typeof useMemo<{
  ...
  StyleSheet.create({
    ...
    taskCard: {
      ...
      marginTop: layout.cardOverlap - 15,
